...
interface SummaryCardsProps {
  ...
  const cards = [
    {
      title: 'Total Income',
      value: formatCurrency(stats.totalIncome, defaultCurrency),
      color: 'bg-[#33A1E0]',
      icon: (
    ...
    {
      title: 'Balance',
      value: formatCurrency(stats.balance, defaultCurrency),
      color: stats.balance >= 0 ? 'bg-[#33A1E0]' : 'bg-[#E63946]',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div key={index} className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-[#154D71] mt-1">{card.value}</p>
            </div>
